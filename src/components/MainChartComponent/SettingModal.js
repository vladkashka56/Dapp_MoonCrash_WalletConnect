...
import SoundSettingImg from '../../assets/images/playpage/soundSettings.png'


import { setBackAudioVolume, setBetButtonVolume, setEffectAudioVolume, setMuteAudio } from '../../actions/gameActions'
const AnimationType = [
    '3D',
    '2D',
    'ORIGINAL'
...
const SettingModal = (props) => {
    const { backgroundAudioVolume, effectAudioVolume, setBetButtonVolume, betButtonVolume, muteAudio, setMuteAudio, setBackAudioVolume,
        setEffectAudioVolume } = props
                ...
                <div className={`absolute prevent-drop timeline-bg ${showAnimation ? 'show' : 'hidden'}`}>
                    ...
                    <div className="sound-content">
                        ...
                        <div className="sound-settings">
                            <table>
                                <tr>
                                    <td className="setting-title">Play Sound</td>
                                    <td className="setting-checkbox">
                                        {/*<label className="check-setting">
                                            <input className='switchCheckbox' name="takeOff" onChange={()=>setMuteAudio(!muteAudio)} checked={muteAudio} type="checkbox"/>
                                            <span></span>
                                        </label*/}
                                        <div id="toggle-btn">
                                            <input onChange={clickMuteBtn} checked={!muteAudio} type="checkbox" id="checkbox-input"/>
                                ...
                                <tr>
                                    <td className="setting-title">Music Volume</td>
                                    <td className="setting-checkbox">
                                        <input type="range" className="sound-slider" onChange={(e)=>setBackAudioVolume(e.target.value)}
                                            min="0" max="100" value={backgroundAudioVolume}/>
                                    </td>
                                </tr>
                                <tr>
                                    <td className="setting-title">Sound effects volume</td>
                                    <td className="setting-checkbox">
                                        <label className="slider-setting">
                                            <input type="range" onChange={(e)=>setEffectAudioVolume(e.target.value)}
                                                min="0" max="100" value={effectAudioVolume}/>
                                            <span></span>
                                        </label>
                                    </td>
                                </tr>
                                <tr>
                                    <td className="setting-title">Bet Button volume</td>
                                    <td className="setting-checkbox">
                                        <label className="slider-setting">
                                            <input type="range" onChange={(e)=>setBetButtonVolume(e.target.value)}
                                                min="0" max="100" value={betButtonVolume}/>
                                            <span></span>
                                        </label>
...
export default connect(mapStateToProps, 
                {setMuteAudio, setBackAudioVolume, setBetButtonVolume, setEffectAudioVolume})(SettingModal)
